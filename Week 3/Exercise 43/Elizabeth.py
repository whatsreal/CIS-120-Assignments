#Elizabeth Murg
#Assignment Number 43. 2/21/2014.
...
class CentralCorridor (Scene ):
	def enter (self ):
		...
		if action == "shoot!" :
			...
			print "The Gothon stops, tries not to laugh, then burst out laughing and can't move."
...
class TheBridge (Scene ):
	def enter (self ):
		...
		print "arm and don't want it set off."
...
class EscapePod (Scene ):
	def enter (self ):
		...
		print "bud you don't have time to look. There's 5 pods, which one"
		print "do you take?"
		...
		if int (guess ) != good_pod :
			...
			print "You jump into the pod   %s and hit the eject button."
